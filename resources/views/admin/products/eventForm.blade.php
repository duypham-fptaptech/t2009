        ...
        <div class="col-xs-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form class="form-horizontal form-bordered" action="/admin/products/eventForm" method="post">
                        @csrf
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="inputDefault">Star Date</label>
                            <div class="col-md-3">
                                <input type="text" class="form-control" id="inputDefault" name="startDate">
                                @error('startDate')
                                <div class="text-danger">* {{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" id="inputDefault" name="endDate">
                                @error('endDate')
                                <div class="text-danger">* {{ $message }}</div>
                                @enderror
                            </div>
