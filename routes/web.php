...
Route::get('/admin/events/create', [EventControlle::class, 'createEvent']);
Route::get('/admin/events', [EventControlle::class, 'eventList']);
Route::post('/admin/events', [EventControlle::class, 'stores']);
